...
| 순서 | Tier | 영역 | 파일 |
|---|---|---|---|
| 0 | ★★ | 사용자 지시사항 처리 9단계 SOP (Step 1~9 + ✓ 체크) | [user_instruction_handling_sop.md](user_instruction_handling_sop.md) |
| 1 | ★ | 작업 절차 체크리스트 (시작/종료 + 펌웨어 플래시 절차) | [workflow.md](workflow.md) |
| 2 | ★ | 코드 작업 규칙 (금지사항·수정 규칙·상수 분리·사전 승인 트리거) | [coding.md](coding.md) |
| 3 | ★ | GitHub 워크플로 (커밋/푸쉬/PR/기록 요청 처리·vendored 가드) | [github.md](github.md) |
